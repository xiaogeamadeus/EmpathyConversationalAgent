...
class IsQuestionChecker:
    ...
    def wait_for_run_completion(self, thread_id, run_id):
        while True:
            ...
            print(f"IsQuestionChecker, Current run status: {run.status}")
    ...
    def run_agent(self, user_input):
        assistant = self.client.beta.assistants.create(
            name="Is Question Checker",
            description="Check whether input include question or not",
            instructions="You are a question checker. I will give you a sentence, return 'True' if the sentence is a "
                         "question or include a question; return 'False' if the sentence isn't a question or don't "
                         "include a question.",
        ...
        if run.status != 'completed':
            print("question checker: ", run.error)
        else:
