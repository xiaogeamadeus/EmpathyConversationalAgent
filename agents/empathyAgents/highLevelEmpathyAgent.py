...
class HighLevelEmpathyAgent:
    ...
    def wait_for_run_completion(self, thread_id, run_id):
        while True:
            ...
            print(f"HighLevelEmpathyAgent, Current run status: {run.status}")
    ...
    def run_agent(self, user_input, listener_response):
        assistant = self.client.beta.assistants.create(
            name="High-level Empathy Advisor",
            description="Giving Advise",
            instructions="You are an psychologist and specialize in giving suitable advise to user. I will give you a "
                         "user input and a possible response. Please edit the response and give suitable advise. The "
                         "input will like user:'', response: ''.",
